...
steps_per_epoch = 143960
epochs = 50
batch_size = 54
feature_filename = str(batch_size) + "_gamma_shuffle_large"
train_data_path = "model/TDT3/"
model_path = "NN_Model/TDT3/DSSM_TD_" + feature_filename + ".h5"
model_weights_path = "NN_Model/TDT3/DSSM_TD_WEIGHTS_" + feature_filename + ".h5"
Epochs_filepath="Epochs/TDT3/with_gamma_single/" + feature_filename + "_weights-{epoch:02d}-{val_loss:.2f}.hdf5"

with open("../Corpus/rel_irrel/TDT3/qry_train_set_large.pkl", "rb") as tr_f : qry_train_set = Pickle.load(tr_f)
with open("../Corpus/rel_irrel/TDT3/qry_val_set.pkl", "rb") as tr_f : val_qry_train_set = Pickle.load(tr_f)
...
with open(train_data_path + "doc_list.pkl", "rb") as doc_lst_f: doc_list = Pickle.load(doc_lst_f)
with open(train_data_path + "doc_model.pkl", "rb") as doc_md_f: doc_model = Pickle.load(doc_md_f)
