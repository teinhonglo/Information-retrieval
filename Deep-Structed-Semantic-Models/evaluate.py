...
class evaluate_model():
	def __init__(self, HMM = False):
		if not HMM:
			self.assessmentTraingSet_path = "../Information-retrieval/Corpus/AssessmentTrainSet/AssessmentTrainSet.txt"
		else:
			self.assessmentTraingSet_path = "../Information-retrieval/Corpus/Train/QDRelevanceTDT2_forHMMOutSideTrain"
