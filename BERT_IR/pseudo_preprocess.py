...
parser.add_argument("--nrm_method",
		     default="SSWLM_E",
		     type=str,
		     required=False)
...
output_name = ""
pseudo_prefix = str(topN) + "_" + NRM_method + "_"
...
if is_training:
    ...
    rel_path = "exp/NRM/pseudo_" + str(topN) + "_NRM_rank_" + NRM_method + "_train"
    if is_spoken:
        rel_path += "_spk.txt"
    else:
        rel_path += ".txt"
