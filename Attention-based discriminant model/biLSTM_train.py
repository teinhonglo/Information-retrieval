...
def train(qry_emb, doc_emb, pointwise_list):
    ...
    batch_size = 32 
    epochs = 55
    Epochs_filepath="NN_Model/TDT2/L2R/Epochs_lstm_100/weights-{epoch:02d}-{loss:.2f}_Emb_adadelta_learn_100_post.hdf5"
    ...
    ''' Create a HDF5 file '''                            
    model.save('NN_Model/TDT2/L2R/LSTM_Emb_adadelta_learn_100_post.h5')
